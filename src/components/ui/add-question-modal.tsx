        ...
        answer:
          questionType === "multipleChoice"
            ? {
                ...
                correctAnswers: options.filter((opt) => opt.isCorrect).map((opt) => opt.id),
              }
      ...
      <DialogContent className="sm:max-w-[650px] bg-zinc-900 border-zinc-800 text-zinc-100">
        <DialogHeader>
          ...
          <DialogDescription className="text-zinc-400">
            Create a new question for your collection. You can use LaTeX for mathematical expressions.
          </DialogDescription>
        </DialogHeader>
            ...
            >
              <div className="flex items-center space-x-2">
                <RadioGroupItem
                  ...
                  id="multipleChoice"
                  className="border-white text-white data-[state=checked]:bg-white data-[state=checked]:text-zinc-900"
                />
